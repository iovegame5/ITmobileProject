                  ...
                  <View style={{ flexDirection: 'row' }}>
                    ...
                    <View style={styles.text}>
                      ...
                      <View style={{ marginTop: 10, marginLeft: 40 }}>
                        <Button title="แก้ไขข้อมูล"   color="blue"onPress={ () => { navigation.navigate("Edit animal information", {key:item.key, Name: item.Name, Detail: item.Detail,  Gender: item.Gender, Image: item.Image, PetType : item.PetType,  Type : item.Type, DateofBirth: item.DateofBirth, Weight : item.Weight}); } } />
                      </View>
                    </View>
                  </View>
                </View>
