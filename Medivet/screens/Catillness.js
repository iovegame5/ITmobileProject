...
class Catillness extends Component {
  constructor() {
    super();

    this.subjCollection = firebase.firestore().collection("Catillness");
                ...
                <View style={styles.card}>
                  ...
                  <View style={{ width: 100, marginLeft: 150, marginTop: 5 }}>
                    <Pressable
                      ...
                      onPress={ () => { navigation.navigate("DetailCatillness", {key:item.key, illnessName: item.illnessName, Symytoms: item.Symytoms, Detail: item.Detail, Cause: item.Cause, Image: item.Image }); } }
                    >
